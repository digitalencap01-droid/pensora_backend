...
from app.db.models.leads import LeadImportJob
from app.modules.leads.import_deduplication import DeduplicationService
...
from app.modules.leads.import_normalization import NormalizationService
from app.modules.leads.import_parsers import ParserFactory
from app.modules.leads.import_validation import ValidationService
...
class UniversalLeadImportService:
    ...
    async def execute_import_supabase(
        ...
        if not field_mappings:
            raw_auto = MappingService.auto_map_headers(parsed_data["headers"])
            field_mappings = {h: info["suggested_field"] for h, info in raw_auto.items()}
